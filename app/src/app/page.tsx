          ...
          transition hover:shadow-[0_16px_32px_rgba(0,0,0,0.12)]">
            ...
            {session ? (
              <>
                ...
                px-2 py-1 rounded-full bg-[rgba(39,174,96,0.25)] text-[#177a43]">
                  ¡Bienvenido de vuelta!
                </span>

                <p className="mt-3 text-sm text-[#6C6F77]">
                  Hola, {session.user?.name}. Accede a todas las funcionalidades desde tu panel de control.
                </p>

                <div className="mt-4">
                  <Link
                    href="/home"
                    className="w-full inline-flex items-center justify-center rounded-[10px]
              ...
              <>
                ...
                <p className="mt-3 text-sm text-[#6C6F77]">
                  Crea tu cuenta y empieza a entender los precios de las viviendas.
                </p>
